public class Principals extends Stop {
    private String pipeMaterial;
    private double scalingFactor;

    public Principals(String name, int pitch, int numberOfPipes, String pipeMaterial, double scalingFactor) {
    ...
    public void generateSound() {
        for (Rank rank : getRanks()) {
            ...
            System.out.println("Physically modeled sound for Principals stop with pitch " + pitch + " and scaled diameter " + scaledDiameter + " generated.");
        }
    }
}
