public class PrincipalMixtures extends Stop {
    private String pipeMaterial;
    private double scalingFactor;

    public PrincipalMixtures(String name, Rank[] ranks, String pipeMaterial, double scalingFactor) {
        super(name, ranks);
    ...
    public void generateSound() {
        for (Rank rank : getRanks()) {
            ...
            double originalDiameter = 10.0; // Assuming an original diameter of 10.0 (can be adjusted)
            ...
            System.out.println("Physically modeled sound for PrincipalMixtures stop with pitch " + pitch + " and scaled diameter " + scaledDiameter + " generated.");
        }
    }
}
