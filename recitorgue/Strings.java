public class Strings extends Stop {
    private String pipeMaterial;
    private double scalingFactor;

    public Strings(String name, int pitch, int numberOfPipes, String pipeMaterial, double scalingFactor) {
    ...
    public void generateSound() {
        for (Rank rank : getRanks()) {
            ...
            double originalDiameter = 7.0; // Assuming an original diameter of 10.0 (can be adjusted)
            ...
            System.out.println("Physically modeled sound for Strings stop with pitch " + pitch + " and scaled diameter " + scaledDiameter + " generated.");
        }
    }
}
